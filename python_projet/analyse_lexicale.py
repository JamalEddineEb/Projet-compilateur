...
class FloLexer(Lexer):
	...
	tokens = { IDENTIFIANT, ENTIER, ECRIRE, INFERIEUR_OU_EGAL, EGALITE, DIFFERENT, INFERIEUR, SUPERIEUR, SUPERIEUR_OU_EGAL, ET, OU, NON, BOOLEAN, TYPE}
